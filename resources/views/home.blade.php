                ...
                <div class="w-full md:w-1/2">
                    <div class="max-w-md mx-auto">
                        ...
                        <p class="mt-5 text-xl leading-7 text-gray-600">
                            ...
                            Nos dedicamos a la investigación, diseño y desarrollo de programas de capacitación
                            teórico-práctico en Manejo Defensivo.

                        </p>
                        <p class="mt-5 text-xl leading-7 text-gray-600">

                            La aprobación del curso le otorgara a usted el carnet de manejo defensivo avalado por YPF y
                            la SFC.
                        ...
                        <div class="grid gap-6 mt-8 sm:grid-cols-2">
                            ...
                            <div>
                                <a href="{{ route('courses.index') }}" type="submit"
                                    class="text-2xl px-6 py-4 bg-yellow-500 text-white rounded-full ">
                                    Ver Curso
                                </a>
                            </div>
                            <br>
