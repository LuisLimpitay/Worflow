            ...
            <div class="flex flex-col space-y-6 md:flex-row md:items-center md:space-x-6">
                ...
                <div class="w-full md:w-1/2">
                    <div class="max-w-md mx-auto">
                        ...
                        <p class="mt-5 text-xl leading-7 text-gray-600">Workflow se propone evaluar y capacitar al personal de las Empresas y/o instituciones de la región, conformándonos como una entidad líder en la prestación de servicios para las diferentes industrias de la region.</p>
...
<br>
                        <div class="text-white relative">
                            ...
                            <div class="grid sm:grid-cols-2 py-10 md:grid-cols-2 lg:grid-cols-2 gap-1 sm:gap-12 ">
                                ...
                                <div
                                    class="group flex items-center bg-indigo-900 gap-2 px-6">
                                    <img class="w-12"
