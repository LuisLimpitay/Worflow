<div>
    ...
    <form action="">
        ...
        <input type="radio" name="payment_method" wire:model="tarjeta">
        <label for="tarjeta">Tarjeta</label><br>

        <input type="radio" name="payment_method" wire:model="transferencia" value="transferencia">
        <label for="transferencia">Transferencia</label><br>

        <input type="radio" name="payment_method" wire:model="efectivo" value="efectivo">
            ...
            <form action="">
                <div class="divide-y divide-gray-200">
                    ...
                    <div class="pt-4 flex items-center space-x-4">
                        <button
                            class="flex justify-center items-center bg-gray-300 w-full text-gray-900 px-4 py-3 rounded-md focus:outline-none">
                ...
                @elseif ($transferencia)
                        ...
                        <div class="divide-y divide-gray-200">
                            ...
                            <div class="pt-4 flex items-center space-x-4">
                                <button
                                    class="flex justify-center bg-gray-300 items-center w-full text-gray-900 px-4 py-3 rounded-md focus:outline-none">
                                    <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M6 18L18 6M6 6l12 12"></path>
