<x-jet-form-section submit="updateProfileInformation">
    ...
    @endif
        ...
        <div class="col-span-6 md: sm:col-span-3">
            ...
            <x-jet-input id="number_license" type="tel" class="mt-1 block w-full" readonly pattern="[0-9]{8}" wire:model.defer="state.number_license" autocomplete="number_license" />
            <x-jet-input-error for="number_license" class="mt-2" />
        </div>

        <!-- Vencimiento Licencias -->
        <div class="col-span-6 md: sm:col-span-3">
            <x-jet-label for="expire_license" value="{{ __('Vencimiento Licencia de Conducir') }}" />
            <x-jet-input id="expire_license" type="date" min="2021-05-11" readonly class="mt-1 block w-full" wire:model.defer="state.expire_license" />
